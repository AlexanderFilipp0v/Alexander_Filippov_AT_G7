...
import homework.day7.playground.processors.RideableProcessor;
...
public class RideableProcessorRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        myRideableProcessor.runRideable(rideableMoped, "никуда");
        myRideableProcessor.runRideable(rideableMotorbike, "повсюду");
    }
}
